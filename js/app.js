...
function sum(a, b) { //eslint-disable-line
  let sumAB = a + b;
  let sumString = `The sum of ${a} and ${b} is ${sumAB}.`;
  return [sumAB, sumString];
}
...
function multiply(a, b) { //eslint-disable-line
  let prodAB = a*b;
  let prodString = `The product of ${a} and ${b} is ${prodAB}.`;
  return [prodAB,prodString];
}
...
sum 
of those three numbers, the second element is the 
product 
